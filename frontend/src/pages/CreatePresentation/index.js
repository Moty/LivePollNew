...
const CreatePresentation = () => {
  ...
  const handleAddActivity = () => {
    ...
    const newActivity = {
      ...
      title: '',
      config: {
        options: selectedActivityType === 'poll' ? [] : undefined,
        questions: selectedActivityType === 'quiz' ? [{
          text: '',
          options: [],
          correctIndex: null
        }] : undefined,
        maxSubmissions: selectedActivityType === 'wordcloud' ? 3 : undefined,
        isModerated: selectedActivityType === 'qa' ? true : undefined
      }
    };
    ...
    <Container>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <ActivitiesSection>
          ...
          {selectedActivityType && !currentActivity && (
